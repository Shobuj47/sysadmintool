...
<div class="row">
	<div class="col-md-4 my-md-5">
			<c:if test="${rolelist != null}">
				<label for="fcidlist">Select Role list:</label>
				<form:select class="form-control" id="roleidlist" path="functionlist" multiple="true">
					<c:forEach var="role" items="${rolelist}" varStatus="st">
						<form:option value="${role.componentId}" label="${functioncode.displayname}"/>
					</c:forEach>
				</form:select>
			</c:if>
	</div>	
	...
	<div class="col-md-4 my-md-5">
			...
			<form:select class="form-control" id="newrolelist" path="functionlist" multiple="true">
